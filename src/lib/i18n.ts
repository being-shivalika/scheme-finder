...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.powered": "Rules-based eligibility matching",
    ...
    "foryou.empty": "No schemes here yet. Check eligibility to get recommendations.",
    "foryou.login": "Sign in to see your dashboard",
  },
  hi: {
    ...
    "hero.powered": "नियम-आधारित पात्रता मिलान",
    ...
    "foryou.empty": "अभी कोई योजना नहीं। सिफारिशों के लिए पात्रता जांचें।",
    "foryou.login": "अपना डैशबोर्ड देखने के लिए साइन इन करें",
  }
};
